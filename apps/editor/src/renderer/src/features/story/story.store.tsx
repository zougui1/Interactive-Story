...
import { type SceneChoice, type SceneChoiceTarget, type Stat, type Story } from '@zougui/interactive-story.story';

import { Electron, getErrorMessage } from '@renderer/utils';
